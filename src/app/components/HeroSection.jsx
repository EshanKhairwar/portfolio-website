    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          Hello! I’m Eshan Khairwar. I am passionate about Web Design. I am a skilled Full-Stack Developer and master in Web development Technology. I am a quick learner and a team worker that gets the job done.
          </p>
          <div>
            <Link
              href="/#contact"
